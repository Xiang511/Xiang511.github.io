...
!function() {
    ...
    function o(e, o, t) {
        return (o = s(o))in e ? Object.defineProperty(e, o, {
            value: t,
            enumerable: !0,
            configurable: !0,
            writable: !0
    ...
    class a {
        static toggle() {
            !1 === a.isExpanded ? t.attr(r, "") : t.removeAttr(r),
    ...
    class T {
        ...
        static off() {
            w.resultVisible && (p.empty(),
            m.hasClass(C) && m.removeClass(C),
            u.addClass(C),
            c.removeClass(C),
            w.off(),
            g.val(""),
    ...
    g.on("input", (()=>{
        "" === g.val() ? x() ? m.removeClass(C) : T.off() : (T.on(),
        x() && m.addClass(C))
    }
    ))
}();
